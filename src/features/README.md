...
errors, the Fleet Management list UI, the shared Add / Edit Vehicle workflow
(`VehicleForm`), and the Vehicle Details fleet profile. Call Server Actions
from UI — never import the repository in components.
