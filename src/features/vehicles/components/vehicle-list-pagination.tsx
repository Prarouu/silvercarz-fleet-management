...
export function VehicleListPagination({ state, meta, className }: VehicleListPaginationProps) {
  ...
  return (
    ...
    >
      <p className="text-sm text-muted-foreground" aria-live="polite">
        {meta.totalItems === 0
          ? 'No records'
          : `Showing ${from}–${to} of ${meta.totalItems} vehicles`}
      </p>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 sm:justify-end">
        <div className="flex items-center gap-2">
          <span
            ...
            id="vehicle-rows-per-page-label"
          >
            Rows per page
          </span>
          <Select
          ...
          >
            <SelectTrigger
              size="sm"
              className="w-[4.5rem]"
              aria-labelledby="vehicle-rows-per-page-label"
            >
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
